...
class ResConfigSettings(models.TransientModel):
    ...
    roomdoo_fastapi_instance_name = fields.Char(
        "Roomdoo FastAPI Instance Name",
        help="Name of the Roomdoo FastAPI instance")
    roomdoo_fastapi_image = fields.Binary(
        "Roomdoo FastAPI Image",
        help="Image of the Roomdoo FastAPI instance")
    ...
    def set_values(self):
        ...
        image_attachment = (
            ...
            .sudo().browse(int(image_parameter))
        )
        if not self.roomdoo_fastapi_image:
            if image_attachment:
                image_attachment.unlink()
            if image_parameter:
                config_parameter_obj_sudo.set_param("roomdoo_fastapi.instance_image", False)
            return res
