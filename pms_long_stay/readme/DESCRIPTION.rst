...
of this type is created, it is automatically split into **weekly** or
**monthly** segments according to the configuration defined on the room
type. The reservation initially created by the user becomes the first
segment, and the remaining segments are generated automatically.
